...
export default class extends React.Component {
  render() {
    ...
    <div class="faqHeader"><h1>Foire aux questions</h1></div>
    <div class="generalHeader"><h2>Général</h2></div>

    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">A qui s'adresse l'application ProfilFood ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Dois-je obligatoirement créer un compte pour utiliser l'application ? Quel est l'intêret des modes en ligne et hors ligne ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Puis-je utiliser l'application sans connexion internet ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">L'application est-elle disponible sur Iphone ou Ipad ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive">L'application est-elle disponible sur tablette Android ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix">Dois-je payer pour utiliser ProfilFood ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven">Mon smartphone est-il trop ancien pour utiliser l'application ?</a>
            </h4>
        </div>
    ...
    <div class="generalHeader"><h2>Alimentation et références</h2></div>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEight">Quelles sont les références de l'application ? Les conseils alimentaires proposés sont-ils vraiment bénéfiques et justes ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseNine">J'ai peur que de renseigner mes repas ait un effet négatif sur mon rapport à l'alimentation et me fasse perdre mon temps.</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTen">Comment les notes des aliments sont-elles calculées ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven">Comment les notes des repas sont-elles calculées ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwelve">Puis-je créer un aliment s'il n'existe pas ?</a>
            </h4>
        </div>
    ...
    <div class="generalHeader"><h2>Profil et famille</h2></div>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThreteen">Mon profil peut-il évoluer au cours du temps ?</a>
            </h4>
        </div>

        <div id="collapseThreteen" class="panel-collapse collapse">
            <div class="panel-body">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFourteen">Mes enfants ne sont-ils pas trop jeunes pour leur créer un compte ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFiveteen">Comment suis-je sûre que l'application ait identifiée mon véritable profil ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSixteen">Comment puis-je inviter une personne dans ma famille ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSeventeen">Je suis coach ou nutritionniste, puis-je utiliser la famille pour planifier les menus de mes élèves ?</a>
            </h4>
        </div>
    ...
    <div class="generalHeader"><h2>Activité quotidienne et objectifs</h2></div>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEighteen">Quels sont les objectifs proposés dans l'application ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseNineteen">Mon activité quotidienne (nombre de pas) varie fortement d'un jour à l'autre, j'ai du mal à faire mon choix entre les 3 proposés (sédentaire, actif et très actif).</a>
            </h4>
        </div>
    ...
    <div class="generalHeader"><h2>Sécurité et dysfonctionnements</h2></div>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwenty">Qui peut accéder à mes données enregistrées sur ProfilFood ?</a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwentyOne">L'application ne démarre pas ou plante au démarrage.</a>
            </h4>
        </div>
